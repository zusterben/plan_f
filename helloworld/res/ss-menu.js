	...
	require(['/res/layer/layer.js'], function(layer) {
		layer.open({
			...
			content: '<div style="padding: 50px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;">\
				<b><% nvram_get("productid"); %> - 科学上网插件 - ' + db_ss["ssconf_basic_version_local"] + '</b><br><br>\
...
function LoadingSSProgress(seconds) {
	action = db_ss["ssconf_basic_action"];
	document.getElementById("LoadingBar").style.visibility = "visible";
	if (action == 0) {
		document.getElementById("loading_block3").innerHTML = "科学上网功能关闭中 ..."
		$("#loading_block2").html("<li><font color='#ffcc00'><a href='https://github.com/zusterben/plan_f' target='_blank'></font>插件工作有问题？请到<em>GITHUB</em>提交issue...</font></li>");
	} else if (action == 1) {
...
function openssHint(itemNum) {
	...
	if (itemNum == 1) {
		...
		width = "500px";
		statusmenu = "此处显示你的SS插件当前的版本号，当前版本：<% dbus_get_def("ssconf_basic_version_local", "未知"); %>,如果需要回滚SS版本，请参考以下操作步骤：";
		...
		statusmenu += "</br>&nbsp;&nbsp;&nbsp;&nbsp;wget --no-check-certificate https://raw.githubusercontent.com/zusterben/plan_f/master/history_package/"+scarch+"/helloworld_1.5.7.tar.gz";
		...
		statusmenu += "</br>回滚其它版本号，请参考<a href='https://github.com/zusterben/plan_f/' target='_blank'><u><font color='#00F'>版本历史列表</font></u></a>";
		...
		//cdns
		statusmenu += "</br><font color='#CC0066'><b>2:cdns：</b></font>"
		...
		statusmenu += "</br>&nbsp;&nbsp;&nbsp;&nbsp;<b>特点：</b>国外解析直连国外DNS服务器；模式2下由cdn.txt定义国内解析名单。";
		//dns2socks
		statusmenu += "</br><font color='#CC0066'><b>3:dns2socks：</b></font>"
		statusmenu += "</br>&nbsp;&nbsp;&nbsp;&nbsp;万金油方案，DNS请求通过socks5隧道转发到vps，然后由vps向你定义的DNS服务器发起tcp dns解析请求，dns2socks是利用了socks5隧道代理，该DNS方案不受到ss服务是否支持udp限制，只要能建立socoks5链接，就能使用。";
		...
		statusmenu += "</br>&nbsp;&nbsp;&nbsp;&nbsp;<b>特点：</b>国外解析通过vps代为请求；模式2下由cdn.txt定义国内解析名单。";
		_caption = "国外DNS";
		//SmartDNS
		statusmenu += "</br><font color='#CC0066'><b>4:SmartDNS：</b></font>"
		statusmenu += "</br>&nbsp;&nbsp;&nbsp;&nbsp;SmartDNS是一个运行在本地的DNS服务器，SmartDNS接受本地客户端的DNS查询请求，从多个上游DNS服务器获取DNS查询结果，并将访问速度最快的结果返回给客户端，提高网络访问速度。";
		statusmenu += "</br>&nbsp;&nbsp;&nbsp;&nbsp;<b>完美兼容国内网络走ipv6国外走ipv4</b>";
		//直连
		...
		statusmenu = "helloworld规则更新包括了gfwlist模式中用到的<a href='https://github.com/zusterben/plan_f/blob/master/rules/gfwlist.conf' target='_blank'><font color='#00F'><u>gfwlist</u></font></a>，在大陆白名单模式和游戏模式中用到的<a href='https://github.com/zusterben/plan_f/blob/master/rules/chnroute.txt' target='_blank'><u><font color='#00F'>chnroute</font></u></a>和<a href='https://github.com/zusterben/plan_f/blob/master/rules/cdn.txt' target='_blank'><u><font color='#00F'>国内cdn名单</font></u></a>"
		...
		statusmenu = "&nbsp;&nbsp;&nbsp;&nbsp;服务端私钥对应的公钥。使用 ./xray x25519 -i \"服务器私钥\" 生成。"
		_caption = "publicKey";
	} else if (itemNum == 113) {
		statusmenu = "&nbsp;&nbsp;&nbsp;&nbsp;服务端 shortIds 之一。0 到 f，长度为 2 的倍数，长度上限为 16。若服务端的 shordIDs 包含空值，客户端可为空。"
		_caption = "shortID";
	} else if (itemNum == 114) {
